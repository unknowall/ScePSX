...
namespace ScePSX
{
    public partial class CheatFrm : UserControl
    {
        ...
        public CheatFrm(string id, PSXCore? core) : this()
        {
            ...
            Title = Translations.GetText("FrmCheat", "forms");
            DiskID = id;
        ...
        {
            cheatCodes.Clear();
            string fn = AHelper.RootPath + $"/Cheats/{DiskID}.txt";
        ...
        private void BtnSave_Click(object? sender, RoutedEventArgs? e)
        {
            ...
            Directory.CreateDirectory(AHelper.RootPath + "/Cheats/");
        ...
        {
            var result = await AHelper.SelectFile("CheatCode", "", true, AHelper.CommonActivity);
