            ...
            switch (instr.opcode)
            {
                case 0b00_0000: //R-Type opcodes
                    switch (instr.function)
                    {
                        case 0b00_0000: //SLL(); break;
                            ...
                            break;
                        case 0b00_0010:
                            output = "SRL R" + instr.rs + " " + (GPR[instr.rt] >> (int)instr.sa);
                            break;
                        case 0b00_0011:
                            output = "SRA";
                            break;
                        ...
                        case 0b10_0011:
                            ...
                            break;
                        case 0b10_0100:
                            output = "AND R" + instr.rd + " R" + instr.rs + " & R" + instr.rt + " " + GPR[instr.rs].ToString("x8") + " & " + GPR[instr.rt].ToString("x8");
                            break;
                        case 0b10_0101:
                            output = "OR";
                            values = "R" + instr.rd + "," + (GPR[instr.rs] | GPR[instr.rt]).ToString("x8");
                            break;
                        case 0b10_0110:
                            output = "XOR R" + instr.rd + " R" + instr.rs + " ^ R" + instr.rt + " " + GPR[instr.rs].ToString("x8") + " ^ " + GPR[instr.rt].ToString("x8");
                            break;
                        case 0b10_0111:
                            output = "NOR";
                            break;
                ...
                case 0b10_0011:// LW(bus);
                    if ((COP0_GPR[SR] & 0x10000) == 0)
                        ...
                        values = "R" + instr.rt + "[" + GPR[instr.rt].ToString("x8") + "], " + instr.imm_s.ToString("x8") + "(" + GPR[instr.rs].ToString("x8") + ")" + "[" + (instr.imm_s + GPR[instr.rs]).ToString("x8") + "]" + " WARNING IGNORED LOAD";
                    output = "LW";
                    break;
                ...
                case 0b10_1011:// SW(bus);
                    ...
                    if ((COP0_GPR[SR] & 0x10000) == 0)
                        ...
                        values = "R" + instr.rt + "[" + GPR[instr.rt].ToString("x8") + "], " + instr.imm_s.ToString("x8") + "(" + GPR[instr.rs].ToString("x8") + ")" + "[" + (instr.imm_s + GPR[instr.rs]).ToString("x8") + "]" + " WARNING IGNORED WRITE";
                    break;
                case 0b10_1110:
                    output = "SWR";
                    break;
                ...
                case 0b11_1010:
                    output = "SWC2";
                    values = "GTE R" + instr.rt + " -> R" + instr.rs + "= " + GPR[instr.rs].ToString("x8") + " + imm: " + instr.imm.ToString("x8") + " = " + (GPR[instr.rs] + instr.imm).ToString("x8");
                    break;
                default:
                    break;
            }
