...
namespace ScePSX.Disassembler
{
    ...
    internal class BIOS_Disassembler
    {
                ...
                case 0xA0:
                    ...
                    switch (function)
                    {
                        ...
                        case 0x14:
                            ...
                            break;
                        case 0x15:
                            msg += $"strcat({biosOutput(arg1)},{biosOutput(arg2)})";
                            break;
                        case 0x16:
                            msg += $"strncat({biosOutput(arg1)},{biosOutput(arg2)},{arg3})";
                            break;
                        case 0x17:
                            msg += $"strcmp({biosOutput(arg1)},{biosOutput(arg2)})";
                            break;
                        case 0x18:
                            msg += $"strncmp({biosOutput(arg1)},{biosOutput(arg2)},{arg3})";
                            break;
                        case 0x19:
                            msg += $"strcpy({biosOutput(arg1)},{biosOutput(arg2)})";
                            break;
                        case 0x1A:
                            msg += $"strncpy({biosOutput(arg1)},{biosOutput(arg2)},{arg3})";
                            break;
                        case 0x1B:
                            msg += $"strlen({biosOutput(arg1)})";
                            break;
                        case 0x1C:
                            msg += $"index(src,char)";
                            break;
                        ...
                        case 0x27:
                            ...
                            break;
                        case 0x28:
                            msg += $"bzero(dst = {arg1:x8},len = {arg2:x8})";
                            break;
                        case 0x29:
                        ...
                        case 0x7B:
                            ...
                            break;
                        case 0x7C:
                            msg += $"CdAsyncGetStatus({arg1:x8})";
                            break;
                        case 0x7D:
                            msg += $"return 0";
                            break;
                        case 0x7E:
                            msg += $"CdAsyncReadSector({arg1:x8)},{arg2:x8},{arg3:x8})";
                            break;
                        case 0x7F:
                        ...
                        case 0xA0:
                            ...
                            break;
                        case 0xA1:
                            msg += $"SystemErrorBootOrDiskFailure({(char)arg1},{arg2:x8})";
                            break;
                        case 0xA2:
                            msg += $"EnqueueCdIntr()";
                            break;
                ...
                case 0xB0:
                    ...
                    switch (function)
                    {
                        ...
                        case 0x06:
                            ...
                            break;
                        case 0x07:
                            msg += $"DeliverEvent(class = {arg1:x8}, spec = {arg2:x8})";
                            break;
                        case 0x08:
                            msg += $"OpenEvent(class = {arg1:x8},spec = {arg2:x8},mode = {arg3:x8},func = {arg4:x8})";
                            break;
                        case 0x09:
                            msg += $"CloseEvent(event = {arg1:x8})";
                            break;
                        case 0x0A:
                            msg += $"WaitEvent(event = {arg1:x8})";
                            break;
                        case 0x0B:
                            return; //msg += $"TestEvent({arg1:x8})"; break; //SPAM
                        case 0x0C:
                            msg += $"EnableEvent(event = {arg1:x8})";
                            break;
                        case 0x0D:
                            msg += $"DisableEvent(event = {arg1:x8})";
                            break;
                        case 0x0E:
                        ...
                        case 0x16:
                            ...
                            break;
                        case 0x17:
                            return; // msg += "ReturnFromException()"; break; //SPAM
                        case 0x18:
                        ...
                        case 0x20:
                            msg += $"UnDeliverEvent({arg1.ToString("x8")},{arg2.ToString("x8")})";
                            break;
                        case 0x21:
                        case 0x22:
                        case 0x23:
                        ...
                        case 0x31:
                            ...
                            break;
                        case 0x32:
                            msg += $"FileOpen({arg1.ToString("x8")},{arg2}) {biosOutput(arg1)}";
                            break;
                        case 0x33:
                            msg += $"FileSeek(fd,offset,seektype)";
                            break;
                        ...
                        case 0x3C:
                            ...
                            break;
                        case 0x3D:
                            return; //msg += $"std_out_putchar({(char)arg1})"; break; //No need for this with TTY
                        case 0x3E:
                            msg += $"std_in_gets(dst)";
                            break;
                        case 0x3F:
        ...
        {
            string output = "";
            char c = (char)bus.read32(addr++);
            while (c != '\0')
            {
                output += c;
                c = (char)bus.read32(addr++);
            }
            return output;
            //return null;
        }
