    ...
    public class MemCard
    {
        ...
        internal byte process(byte value)
        {
            ...
            switch (transferMode)
            {
                ...
                case TransferMode.Id:
                    //Console.WriteLine($"[MEMCARD] ID TransferMode {value:x2}");
                    return 0xFF;
            }
            ...
            switch (mode)
            {
                ...
                default:
                    //Console.WriteLine("[MEMCAR]] Unreachable Mode Warning");
                    ack = false;
                    return 0xFF;
            }
        }
        ...
        */
        private byte readMemory(byte value)
        {
            ...
            {
                case 0:
                    return MEMORY_CARD_ID_1;
                case 1:
                    return MEMORY_CARD_ID_2;
                case 2:
                ...
                case 3:
                    ...
                    return 0;
                case 4:
                    return MEMORY_CARD_COMMAND_ACK_1;
                case 5:
                    return MEMORY_CARD_COMMAND_ACK_2;
                case 6:
                    return addressMSB;
                case 7:
                    return addressLSB;
