...
#pragma warning restore SA1311 // Static readonly fields should begin with upper-case letter
        ...
        {
            internal ObjectSerializationInfo.EmittableMember? MemberInfo
            {
                get; set;
            }

            internal LocalBuilder? LocalVariable
            {
                get; set;
            }

            internal LocalBuilder? IsInitializedLocalVariable
            {
                get; set;
            }

            internal Label SwitchLabel
            {
                get; set;
            }
        }
    ...
    internal class ObjectSerializationInfo
    {
        ...
        internal bool ShouldUseFormatterResolver
        {
            get; private set;
        }

        internal ConstructorInfo? BestmatchConstructor
        {
            get;
        }

        internal EmittableMemberAndConstructorParameter[] ConstructorParameters
        {
            get;
        }

        internal EmittableMember[] Members
        {
            get;
        }
        ...
        internal class EmittableMemberAndConstructorParameter
        {
            ...
            internal EmittableMember MemberInfo
            {
                get;
            }

            internal ParameterInfo ConstructorParameter
            {
                get;
            }
        }
        ...
        internal class EmittableMember
        {
            ...
            internal bool IsWrittenByConstructor
            {
                get; set;
            }
            ...
            /// </summary>
            internal bool IsExplicitContract
            {
                get; set;
            }
