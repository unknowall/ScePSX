...
namespace LightVK
{
    ...
    {
        public readonly ulong Handle;
        public VkPipelineBinaryKHR(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkIndirectCommandsLayoutNV(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkIndirectCommandsLayoutEXT(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkIndirectExecutionSetEXT(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkDescriptorUpdateTemplate(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkSamplerYcbcrConversion(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkAccelerationStructureKHR(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkAccelerationStructureNV(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkPerformanceConfigurationINTEL(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkBufferCollectionFUCHSIA(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkDeferredOperationKHR(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkPrivateDataSlot(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkPrivateDataSlotEXT(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkCuModuleNVX(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkCuFunctionNVX(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkOpticalFlowSessionNV(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkMicromapEXT(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkShaderEXT(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkTensorARM(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkTensorViewARM(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkDataGraphPipelineSessionARM(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkDebugUtilsMessengerEXT(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkVideoSessionKHR(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkVideoSessionParametersKHR(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkSemaphoreSciSyncPoolNV(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkCudaModuleNV(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly ulong Handle;
        public VkCudaFunctionNV(ulong existingHandle)
        {
            Handle = existingHandle;
        }
    ...
    {
        public readonly IntPtr Handle;
        public VkExternalComputeQueueNV(IntPtr existingHandle)
        {
            Handle = existingHandle;
        }
