...
namespace DirectX.D2D1
{
    ...
    public sealed class D2D1HwndRenderTarget : D2D1Resource
    {
        ...
        public void DrawBitmap(D2D1Bitmap bitmap, D2D1RectF destinationRectangle)
        {
            ...
            try
            {
                this.RenderTarget.DrawBitmap(bitmap.GetHandle<ID2D1Bitmap>(), destinationRectangleHandle.AddrOfPinnedObject(), 1.0f, D2D1BitmapInterpolationMode.Linear, IntPtr.Zero);
            } finally
            {
        ...
        public void DrawBitmap(D2D1Bitmap bitmap, D2D1RectF destinationRectangle, float opacity)
        {
            ...
            try
            {
                this.RenderTarget.DrawBitmap(bitmap.GetHandle<ID2D1Bitmap>(), destinationRectangleHandle.AddrOfPinnedObject(), opacity, D2D1BitmapInterpolationMode.Linear, IntPtr.Zero);
            } finally
            {
                destinationRectangleHandle.Free();
            }
